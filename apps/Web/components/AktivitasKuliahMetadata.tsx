export default function AktivitasKuliahMetadata() {
  return (
        ...
        <div className="ak-metadata-nested-area">
          <div className="ak-metadata-nested">
            <div className="ak-metadata-field">
              ...
              <select className="ak-metadata-field__select" id="tahun-ajaran">
                <option value="2022">2022</option>
              </select>
            </div>
            <div className="ak-metadata-field">
              <label htmlFor="semester" className="ak-metadata-field__label">
                Semester
              </label>
